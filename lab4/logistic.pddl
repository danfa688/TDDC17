...
(define (domain logistics)
  ...
  (:predicates
   ...
   ;; Static predicates:
   (big_v ?v) (small_v ?v) (big_o ?o) (small_o ?o) (object ?o) (truck ?t) (airplane ?p) (train ?r) (vehicle ?v)
   (location ?l) (airport ?a) (city ?c) (trainstation ?s) (loc ?l ?c)
  ...
  (:action load
    ...
    :precondition (and (object ?o) (vehicle ?v) (location ?l)
		       (at ?v ?l) (at ?o ?l) (or (and(big_v ?v) (big_o ?o))
		        (and(small_v ?v) (small_o ?o)) (and(big_v ?v) (small_o ?o)) ))
  ...
  ;; Take a train between two trainsations
  (:action rail
  	:parameters (?r ?s1 ?s2)
